...
int main(int argc, char **argv) {
	...
	t.thread_info.status = klee_int("thread info status");
...
int main(int argc, char **argv) {
  ...
  klee_make_symbolic(&regs, sizeof(struct pt_regs), "pt_regs");
	...
	klee_make_symbolic(&rlimit, sizeof rlimit, "rlimit");
	regs.si = (unsigned long) &rlimit;
